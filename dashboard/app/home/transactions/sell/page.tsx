  ...
  return (
    <Fragment>
      <div className="pb-[50px]">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-[20px]">
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-border-light dark:border-border-dark shadow-sm">
              <div className="flex flex-row items-center space-x-[10px] mb-6">
                <h2 className="text-lg mt-[5px] font-semibold text-text-light-primary dark:text-text-dark-primary">
                  Transaction Summary
                </h2>
              </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-border-light dark:border-border-dark shadow-sm">
              ...
              <div className="space-y-4">
                <button
                  ...
                  className="w-full flex text-[14px] items-center justify-center gap-2 px-4 py-3 bg-primary text-white font-semibold rounded-lg hover:bg-purple-700 transition-colors"
                >
                ...
                <button
                  ...
                  className="w-full flex text-[14px] items-center justify-center gap-2 px-4 py-3 bg-red-600 text-white font-semibold rounded-lg hover:bg-red-700 transition-colors"
                >
      ...
      <Modal isOpen={paid}>
        <ConfirmModal
          ...
          message="Are you sure you want to confirm the reciept of payment? this action cannot be undone"
